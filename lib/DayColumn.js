  ...
  function DayColumn() {
    ...
    _this._selectable = function() {
      ...
      var selectorClicksHandler = function selectorClicksHandler(
        ...
        var container = (0, _reactDom.findDOMNode)(
          (0, _assertThisInitialized2.default)(_this)
        )

        if (
          !(0, _Selection.isEvent)(container, box) &&
          (0, _Selection.isOverContainer)(container, box.x, box.y)
        ) {
    ...
    return /*#__PURE__*/ _react.default.createElement(
      ...
      isNow &&
        ...
        /*#__PURE__*/ _react.default.createElement(
          ...
          /*#__PURE__*/ _react.default.createElement(CurrentTimeIndicator, null)
        )
    )
  }
...
DayColumn.propTypes =
  process.env.NODE_ENV !== 'production'
    ? {
        ...
        showLabelTop: _propTypes.default.bool,
      }
    : {}
