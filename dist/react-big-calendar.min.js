!(function(e, t) {
  ...
  function ha(e, t, n) {
    if (!t) return e
    var r = va[t]
    return r ? r(e, n) : (console.log('fn not found', t), e)
  }
  function ma(e, t, n) {
    ...
    var t,
      ...
      P = [
        ...
        r.createElement(
          ...
          E ? r.createElement(E, { event: s, title: S }) : S
        ),
      ],
      A = i(
        {},
        ...
        g
          ? (((t = {
              ...
              height: qc(j),
              width: 'calc(' + k + ' + 10px)',
            })[l ? 'right' : 'left'] = qc(Math.max(0, N))),
            t)
          : (((n = { top: qc(T), width: qc(k), height: qc(j) })[
              l ? 'right' : 'left'
            ] = qc(N)),
            n)
      )
    return r.createElement(
      ...
      r.createElement(
        'div',
        {
          ...
          style: A,
          onKeyPress: b,
          title: D ? ('string' == typeof p ? p + ': ' : '') + D : void 0,
          className: f(
          ...
          (t.renderEvents = function(e) {
            ...
            return (function(e) {
              ...
              var a,
                ...
                w = m.startsBeforeDay(g),
                E = m.startsAfterDay(v)
              w
                ? (b = 'eventTimeRangeEndFormat')
                : E && (b = 'eventTimeRangeStartFormat'),
                (a = w && E ? y.allDay : l.format({ start: g, end: v }, b))
              var _ = w || m.startsBefore(g),
                S = E || m.startsAfter(v)
            ...
            b &&
              r.createElement(
                'div',
                {
                  ...
                  style: { top: w, height: E },
                },
                r.createElement('span', null, l.format(_, 'selectRangeFormat'))
              ),
            a &&
